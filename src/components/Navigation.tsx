      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center">
            <img src="/lovable-uploads/90186684-002c-46fa-b421-f218cd9c8ebb.png" alt="Precise Point Barber Studio" className="h-12 w-auto object-fill" />
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Button asChild className="bg-gold hover:bg-gold-dark text-black font-semibold">
              <a href="https://getsquire.com/discover/barbershop/precise-point-barber-studio-dartmouth?hl=en-CA&gei=0CI9aJzcGfqe5NoPopiVqAg&gsas=1&ahbb=1&rwg_token=ACgRB3e9WsBMuE6yvBY3ALSq5KHnJ9ICr0NDBeYAM0uCAezR_Z2F-jZh1f77md8Bh2JB5OnK1uGhYV710fbKBmz1GD7MueULBQ%3D%3D">Book Now</a>
            </Button>
          </div>
        ...
        {/* Mobile Navigation */}
        {isOpen && <div className="md:hidden absolute top-16 left-0 right-0 bg-black/95 backdrop-blur-sm border-t border-gold/20">
