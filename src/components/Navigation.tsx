          ...
          <div className="md:hidden absolute top-24 left-0 right-0 bg-black/95 backdrop-blur-sm border-t border-gold/20">
            <div className="px-4 py-6 space-y-4">
              ...
              <Button asChild className="w-full bg-gold hover:bg-gold-dark text-black font-semibold mt-4">
                <a
                  href="https://getsquire.com/discover/barbershop/precise-point-barber-studio-dartmouth?hl=en-CA&gei=0CI9aJzcGfqe5NoPopiVqAg&gsas=1&ahbb=1&rwg_token=ACgRB3e9WsBMuE6yvBY3ALSq5KHnJ9ICr0NDBeYAM0uCAezR_Z2F-jZh1f77md8Bh2JB5OnK1uGhYV710fbKBmz1GD7MueULBQ%3D%3D"
                  onClick={() => setIsOpen(false)}
                >
                  Book Now
                </a>
